...
import io.katharsis.core.engine.properties.ResourceFieldImmutableWriteBehavior;
...
public class KatharsisProperties {
	 ...
	 * Refer to {@link io.katharsis.resource.annotations.JsonApiLookupIncludeAutomatically} for only adding it to a specific
	 * field.
	 *
	 * @since 2.8.2
	 */
	 ...
	 * Refer to {@link io.katharsis.resource.annotations.JsonApiLookupIncludeAutomatically}.overwrite for only adding it to a
	 * specific field.
	 *
	 * @since 2.8.2
	 */
