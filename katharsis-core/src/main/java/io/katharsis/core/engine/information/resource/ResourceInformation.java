...
import io.katharsis.core.engine.internal.information.resource.ResourceAttributesBridge;
import io.katharsis.core.exception.MultipleJsonApiLinksInformationException;
import io.katharsis.core.exception.MultipleJsonApiMetaInformationException;
import io.katharsis.core.exception.ResourceDuplicateIdException;
...
/**
 * Holds information about the type of the document.
 */
public class ResourceInformation {
	...
	/**
	 * Type name of the document. Corresponds to {@link JsonApiResource.type}
	 * for annotated resources.
	 */
	private String resourceType;

	/**
	 * Found field of the id. Each document has to contain a field marked by
	 * JsonApiId annotation.
	 */
	private final ResourceField idField;

	/**
	 * A set of document's attribute fields.
	 */
	...
	/**
	 * Creates a new instance of the given document.
	 */
	...
	/**
	 * Returns a set of field names which are not basic fields (document
	 * attributes)
	 *
