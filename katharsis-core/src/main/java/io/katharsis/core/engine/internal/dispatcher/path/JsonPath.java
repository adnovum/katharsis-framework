...
/**
 * Represent a JSON API path sent to the server. Each document or field defined in the path is represented by one
...
public abstract class JsonPath {
    ...
    /**
     * Returns name of a document the last document in requested path.
     * There can be paths that concern relations. In this case a elementName from parent JsonPath should be retrieved.
     *
     * @return nam of the lase document
     */
    public abstract String getResourceName();

    /**
     * Returns name of the current element. It can be either document type or document's field.
     *
