package io.katharsis.core.engine.internal.information.resource;
...
/**
 * Classes which implement those interface are able to provide a set of document attributes
 */
public class ResourceAttributesBridge<T> {
    ...
    /**
     * The document has to have both method annotated with {@link JsonAnySetter} and {@link JsonAnyGetter} to allow
     * proper handling.
     *
     * @return <i>true</i> if document definition is incomplete, <i>false</i> otherwise
     */
