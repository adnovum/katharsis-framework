...
import io.katharsis.core.engine.filter.RepositoryBulkRequestFilterChain;
import io.katharsis.core.engine.filter.RepositoryFilter;
import io.katharsis.core.engine.filter.RepositoryFilterContext;
import io.katharsis.core.engine.filter.RepositoryLinksFilterChain;
...
import io.katharsis.core.engine.filter.RepositoryResultFilterChain;
 ...
 * repositories. Every document can return either a document object or a
 ...
 * <p>
 * The methods need to know if a document is interface- or annotation-based
 * since document methods have different signatures.
 */
