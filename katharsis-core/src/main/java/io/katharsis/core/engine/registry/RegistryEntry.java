...
import io.katharsis.core.exception.RelationshipRepositoryNotFoundException;
...
/**
 * Holds information about a document of type <i>T</i> and its repositories. It
 * includes the following information: - ResourceInformation instance with
 * information about the document, - ResourceEntry instance, - List of all
 * repositories for relationships defined in document class. - Parent
 * RegistryEntry if a document inherits from another document
 *
 * @param <T>
 *            document type
 */
