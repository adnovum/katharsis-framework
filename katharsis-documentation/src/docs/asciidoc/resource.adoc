...
A resource as defined by JSON API holds the actual data. `katharsis-engine` is agnostic to how such resources are actually
implemented (see the architecture and modueles chapters). This chapter gives information of the most common way using
annotations provided by `katharsis-core`.
