...
import io.katharsis.core.exception.UnauthorizedException;
...
public class SecurityModuleIntTest extends JerseyTest {
	...
	private static void setBasicAuthentication(KatharsisClient client, final String userName, final String password) {
	...
	private class TestApplication extends ResourceConfig {
		...
		public TestApplication() {
			property(KatharsisProperties.RESOURCE_SEARCH_PACKAGE, Project.class.getPackage().getName());
